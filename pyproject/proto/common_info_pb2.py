...
_EVENT_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ev_syn_zhuang', index=31, number=120,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_SYN_GAME_INFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='card_info', full_name='syn_game_info.card_info', index=8,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='opt_pos', full_name='syn_game_info.opt_pos', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pos_owner', full_name='syn_game_info.pos_owner', index=11,
...
_ON_TOUCH_EVENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ev_target_src', full_name='on_touch_event.ev_target_src', index=3,
...
_NOTIC_MSG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='msg_id', full_name='notic_msg.msg_id', index=0,
      number=1, type=13, cpp_type=3, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='msg_content', full_name='notic_msg.msg_content', index=1,
